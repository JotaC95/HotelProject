...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-b=!3l2398$dd**wo-v8+pnd615oqqt@q29fiygbqr(-1_qvrz0')
...
MIDDLEWARE = [
    ...
    'hotel_backend.middleware.RequestLogMiddleware', # Debug Logging
